...
yolo_results = yolo_model(image, device='cuda')[0]
...
sam_results = sam_model(image, bboxes=bboxes, device='cuda')[0]
...
if len(solo_personas) > 0:
    ...
    sam_personas_results = sam_model(image, bboxes=bboxes_personas, device='cuda')[0]
...
yolo_results2  = yolo_model(image2, device='cuda')[0]
